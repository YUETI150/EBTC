...
##添加新的column “id后缀”， 对比the combination of “dailydonse” and “studyid” 若不同则产生新的后缀。等后缀都产生之后，在与studyid结合（1.1）
...
####################################################################################################################################################################################
####step2####
#calculate the means of each treated group and control group. (discuss with Yue Tian)


###### unify the unit of variability and transfer the values of SE/SD
##Question1: Do we convert SE values to SD or SD to SE? (answer: SD)
#Question2: In the column "Numberofexperimentalunits", there are some range of numbers (i.e. 3-4), and the mean of them is not
#even number (i.e. (3+4)/2 = 3.5). How do we convert these values? (answer: we can take decimals)
